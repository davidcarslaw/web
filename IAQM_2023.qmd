...
![](images/plume.png){.absolute top="700" left="660" width="600"}
...
1. Examples of `openair` Functions

1. 'De-weathering' Air Quality Data
...
::: {.column width="60%"}
<br>
[![](images/openair_book.png)](https://bookdown.org/david_carslaw/openair/)
...
<hr>
<br>
There *a lot* of air quality sites available across many networks accessible by `openair`
...
::: {.column width="60%"}
<br>
![](images/uk_sites.png){.absolute top="220" left="800" width="1200"}
